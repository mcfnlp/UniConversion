...
{
    class GandamarLetterToMyanmar3
    {
        public static string Gandamar2Uni(string input)
        {
            String unistr = "";
           ...
           // unistr = Regex.Replace(unistr, "['°]", "ဒ");
            ...
            unistr = Regex.Replace(unistr, "î", "ြ");
            ...
            unistr = Regex.Replace(unistr, ":", "ါ်");//Visarga
