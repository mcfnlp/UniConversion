    ...
    public class Converter
    {
        ...
        public static string Convert(string srcTxt, ConvertOption option)
        {
            ...
            switch (option)
            {
                ...
                case ConvertOption.ATypeWriter: uniTxt = ATypeWriterToMyanmar3.AType2Uni(srcTxt); break;
                ...
                case ConvertOption.Gandamar2Uni: uniTxt = GandamarLetterToMyanmar3.Gandamar2Uni(srcTxt); break;
                ...
                case ConvertOption.Myanmar2Uni: uniTxt = MMyanmar1ToMyanmar3.Myanmar2Uni(srcTxt); break;
